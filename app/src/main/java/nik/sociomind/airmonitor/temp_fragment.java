...
public class temp_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lineChart = v.findViewById(R.id.pcharttemp);
        myCalendar= Calendar.getInstance();
        Entries = v.findViewById(R.id.tempEntries);
        from_date= v.findViewById(R.id.temp_from);
        ftemp = v.findViewById(R.id.fetch_temp);
        to_date = v.findViewById(R.id.temp_to);
        from_datet = v.findViewById(R.id.temp_fromt);
        to_datet = v.findViewById(R.id.temp_tot);
        fromdset = v.findViewById(R.id.fromdatesettemp);
        todset = v.findViewById(R.id.todatesettemp);
        fromtset = v.findViewById(R.id.fromtimesettemp);
        totset = v.findViewById(R.id.totimesettemp);
        ...
        ftemp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private  void runTestQuery(Connection conn, String from, String to) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Log.d(TAG, "runTestQuery: "+rs.getString("Temperature"));
                data.add(new Entry(count,Float.parseFloat(temp),new SimpleDateFormat("YYYY-MM-dd HH:mm:ss").parse(timestamp)));
...
//        chart.getRenderer().getGridPaint().setGridColor(Color.WHITE & 0x70FFFFFF);
    ...
    /*    chart.getAxisLeft().setLabelCount(10,true);
        ...
        //   chart.animateX(2500);
        temp_fragment.MyMarkerView markerView = new temp_fragment.MyMarkerView(getContext(),R.layout.aqimarker);
