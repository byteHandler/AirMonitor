...
public class gas_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lineChart = v.findViewById(R.id.pchartgas);
        myCalendar= Calendar.getInstance();
        Entries = v.findViewById(R.id.gasEntries);
        from_date= v.findViewById(R.id.gas_from);
        fgas = v.findViewById(R.id.fetch_gas);
        to_date = v.findViewById(R.id.gas_to);
        from_datet = v.findViewById(R.id.gas_fromt);
        to_datet = v.findViewById(R.id.gas_tot);
        fromdset = v.findViewById(R.id.fromdatesetgas);
        todset = v.findViewById(R.id.todatesetgas);
        fromtset = v.findViewById(R.id.fromtimesetgas);
        totset = v.findViewById(R.id.totimesetgas);
        ...
        fgas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private  void runTestQuery(Connection conn, String from, String to) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Log.d(TAG, "runTestQuery: "+rs.getString("gas"));
                data.add(new Entry(count,Float.parseFloat(gas),new SimpleDateFormat("YYYY-MM-dd HH:mm:ss").parse(timestamp)));
...
//        chart.getRenderer().getGridPaint().setGridColor(Color.WHITE & 0x70FFFFFF);
    ...
    /*    chart.getAxisLeft().setLabelCount(10,true);
        ...
        //   chart.animateX(2500);
        gas_fragment.MyMarkerView markerView = new gas_fragment.MyMarkerView(getContext(),R.layout.aqimarker);
