...
public class lpg_fragment extends Fragment {
    TextView from_date;
    Calendar myCalendar;
    TextView Entries;
    TextView to_date;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.lpg_fragment,container,false);
        lineChart = v.findViewById(R.id.pchartlpg);
        myCalendar= Calendar.getInstance();
        Entries = v.findViewById(R.id.lpgEntries);
        from_date= v.findViewById(R.id.lpg_from);
        flpg = v.findViewById(R.id.fetch_lpg);
        to_date = v.findViewById(R.id.lpg_to);
        from_datet = v.findViewById(R.id.lpg_fromt);
        to_datet = v.findViewById(R.id.lpg_tot);
        fromdset = v.findViewById(R.id.fromdatesetlpg);
        todset = v.findViewById(R.id.todatesetlpg);
        fromtset = v.findViewById(R.id.fromtimesetlpg);
        totset = v.findViewById(R.id.totimesetlpg);
        ...
        flpg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private LineData getData1() {
        ...
        LineDataSet set1 = new LineDataSet(values, "MQ-02 Values");
    ...
    private  void runTestQuery(Connection conn, String from, String to) {
        ...
        try {
            ...
            while (rs.next()) {
                String lpg = rs.getString("MQ02");
                String timestamp = rs.getString("tstamp");
                Log.d(TAG, "runTestQuery: "+rs.getString("MQ02"));
                data.add(new Entry(count,Float.parseFloat(lpg),new SimpleDateFormat("YYYY-MM-dd HH:mm:ss").parse(timestamp)));
                System.out.print(", lpg: " + lpg+"\n");
                count += 1;
            }
