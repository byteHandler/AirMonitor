...
public class PM25_fragment extends Fragment {
    TextView from_date;
    Calendar myCalendar;
    TextView Entries;
    TextView to_date;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.pm25_fragment,container,false);
        lineChart = v.findViewById(R.id.pchartpm25);
        myCalendar= Calendar.getInstance();
        Entries = v.findViewById(R.id.pm25Entries);
        from_date= v.findViewById(R.id.pm25_from);
        fpm25 = v.findViewById(R.id.fetch_pm25);
        to_date = v.findViewById(R.id.pm25_to);
        from_datet = v.findViewById(R.id.pm25_fromt);
        to_datet = v.findViewById(R.id.pm25_tot);
        fromdset = v.findViewById(R.id.fromdatesetpm25);
        todset = v.findViewById(R.id.todatesetpm25);
        fromtset = v.findViewById(R.id.fromtimesetpm25);
        totset = v.findViewById(R.id.totimesetpm25);
        ...
        fpm25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private  void runTestQuery(Connection conn, String from, String to) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Log.d(TAG, "runTestQuery: "+rs.getString("PM25"));
                data.add(new Entry(count,Float.parseFloat(PM25),new SimpleDateFormat("YYYY-MM-dd HH:mm:ss").parse(timestamp)));
...
//        chart.getRenderer().getGridPaint().setGridColor(Color.WHITE & 0x70FFFFFF);
    ...
    /*    chart.getAxisLeft().setLabelCount(10,true);
        ...
        //   chart.animateX(2500);
        PM25_fragment.MyMarkerView markerView = new PM25_fragment.MyMarkerView(getContext(),R.layout.aqimarker);
