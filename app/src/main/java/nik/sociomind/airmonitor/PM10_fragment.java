...
public class PM10_fragment extends Fragment {
    TextView from_date;
    Calendar myCalendar;
    TextView to_date;
    TextView from_datet;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.pm10_fragment,container,false);
        lineChart = v.findViewById(R.id.pchartpm10);
        myCalendar= Calendar.getInstance();
        from_date= v.findViewById(R.id.pm10_from);
        fpm10 = v.findViewById(R.id.fetch_pm10);
        to_date = v.findViewById(R.id.pm10_to);
        from_datet = v.findViewById(R.id.pm10_fromt);
        to_datet = v.findViewById(R.id.pm10_tot);
        fromdset = v.findViewById(R.id.fromdatesetpm10);
        todset = v.findViewById(R.id.todatesetpm10);
        fromtset = v.findViewById(R.id.fromtimesetpm10);
        totset = v.findViewById(R.id.totimesetpm10);
        ...
        fpm10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PM10_fragment.ConnectMySql connectMySql = new PM10_fragment.ConnectMySql();
    ...
    private  void runTestQuery(Connection conn, String from, String to) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Log.d(TAG, "runTestQuery: "+rs.getString("PM10"));
                data.add(new Entry(count,Float.parseFloat(pm10),new SimpleDateFormat("YYYY-MM-dd HH:mm:ss").parse(timestamp)));
...
//        chart.getRenderer().getGridPaint().setGridColor(Color.WHITE & 0x70FFFFFF);
    ...
    /*    chart.getAxisLeft().setLabelCount(10,true);
        ...
        //   chart.animateX(2500);
        PM10_fragment.MyMarkerView markerView = new PM10_fragment.MyMarkerView(getContext(),R.layout.aqimarker);
